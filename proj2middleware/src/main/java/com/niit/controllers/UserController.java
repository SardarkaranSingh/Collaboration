...
public ResponseEntity<?> registerUser(@RequestBody User user)
{
	...
	{
		ErrorClazz error=new ErrorClazz(1,"email already exist..please enter difrent email");
	...
	{
		ErrorClazz error=new ErrorClazz(2,"some required feilds are emty"+e.getMessage());
